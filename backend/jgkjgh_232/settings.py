"""
Django settings for jgkjgh_232 project.
...
WSGI_APPLICATION = 'jgkjgh_232.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jgkjgh_232 API",
    "DESCRIPTION": "API documentation for jgkjgh_232 App",
    "VERSION": "v1",
}
